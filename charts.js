  ...
  function buildCharts(sample) {
    ...
    d3.json("samples.json").then((data) => {
     // 3. Create a variable that holds the samples array. 
      ...
      var sampleValues = firstSample.sample_values.map((value) => parseInt(value));
    ...
    var gaugeNumber = metadata.filter(metaObj => metaObj.id == sample);
    var firstGauge = gaugeNumber[0];
    
    // Create variables that hold the otu_ids, otu_labels, and sample_values.


    // 3. Create a variable that holds the washing frequency.
      var washingFrequency = parseFloat(firstGauge.wfreq);
